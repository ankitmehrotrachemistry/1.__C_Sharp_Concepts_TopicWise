...
namespace ListCollectionExample
{
    public class Program
    {
        public static void Main()
        {
            ...
            // Use Exists method when you want to check if an item exists or not in the list based on a condition
            ...
            // Use Find() method, if you want to search an element by a conditions 
